...
const Membership = () => {
  const benefits = [
    {
      ...
      description:
        "Connect with like-minded individuals who share your cultural heritage and values.",
      bgColor: "bg-blue-50",
    ...
    },
    {
      ...
      description:
        "Play an active role in preserving and promoting Ewe culture for future generations.",
      bgColor: "bg-green-50",
    ...
    },
    {
      ...
      description:
        "Access opportunities for personal and professional development through our programs.",
  ...
  return (
    <>
      <Banner
        title="Membership"
        message="Join our growing community and be part of something bigger than yourself"
      />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
              Discover the compelling reasons to join LECA and become part of
            ...
            {benefits.map((benefit) => (
              ...
              >
                ...
                <div className="relative mb-6">
                  <div
                    className={`w-20 h-20 mx-auto ${benefit.bgColor} rounded-full flex items-center justify-center group-hover:shadow-lg transition-shadow duration-300`}
                  >
                    <div className={benefit.iconColor}>{benefit.icon}</div>
                  </div>
                  {/* Background circle for depth */}
                  <div
                    className={`absolute inset-0 w-24 h-24 mx-auto ${benefit.bgColor} opacity-30 rounded-full -z-10 group-hover:opacity-50 transition-opacity duration-300 transform translate-x-2 translate-y-2`}
                  ></div>
                </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                  Enjoy exclusive benefits and opportunities available only to
                  LECA members
                </p>
              </div>
      ...
      <div className="bg-gray-50 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-8 max-w-3xl mx-auto">
            Take the first step towards becoming part of our vibrant community.
            Your journey with LECA starts here.
          </p>
          {/* CTA Button */}
          <div className="flex gap-5 item-center justify-center flex-wrap">
            <Link
              to="/membership/register"
              className="inline-flex items-center gap-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-4 px-8 rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105"
            >
              <UserIcon />
              Register Now
            </Link>
